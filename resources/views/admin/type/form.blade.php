<div class="row mb-3">
    <div class="col-sm-12 col-md-4 my-2">
        ...
        <label for="name" class="form-label">@lang('common.name',['model' => trans('type.type')])</label>
    ...
    <div class="col-sm-12 col-md-4 my-2">
        ...
        <label for="bn_name" class="form-label">@lang('common.bn_name',['model' => trans('type.type')])</label>
    ...
    <div class="col-sm-12 col-md-4 my-2">
        ...
        <label for="status" class="form-label">@lang('common.status',['model' => trans('type.type')])</label>
        <sup class="text-danger">*</sup>
        <div class="form-group form-group-check pl-4">
            <div class="form-check-custom">
                ...
                <label class="form-check-label" for="active">
                    @lang('common.active',['model' => trans('type.type')])
                </label>
            </div>
            ...
            <div class="form-check-custom">
                ...
                <label class="form-check-label" for="inactive">
                    @lang('common.inactive',['model' => trans('type.type')])
                </label>
            </div>
...
<div class="row">
    <div class="col-md-12 text-right">
        <button type="submit" class="btn btn-primary waves-effect waves-light">
            <i class="fa fa-save"></i> @lang('common.submit',['model' => trans('type.type')])
        </button>
    </div>
</div>
