...
<script>
    ...
    function SelectChange(url, to_class, selectObject){
        ...
        /*
        *    url => the route for getting the dependent data like route('get_districts') or route('get_districts_by_division')
        *
        *    to_class => target field like district must have to_class value
        *
        *    selectObject => to capture the current value of the drop-down selectObject is used. 'this' is passed from front-end form
        *
        * */
    ...
    function SelectChangeDependent(url,to_class, selectObject, filterClass){
        ...
        *    selectObject => to capture the current value of the drop-down selectObject is used. 'this' is passed from front-end form
        *
        *    filterClass => this class is for the additional dependent field.
        *               For example- product is dependent on both category and model. Assume that you are changing category,
        *               then model must have this filterClass and vice-versa
        *
        * */
