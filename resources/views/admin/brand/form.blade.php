<div class="row mb-3">
    ...
    <div class="col-sm-12 col-md-4 my-2">
        ...
        <label for="country_id" class="form-label">@lang('brand.country')</label>
        <sup class="text-danger">*</sup>
        <div class="form-group">
            {{ Form::select('country_id', $countries, null, ['class' => $error_class.'form-control select2', 'placeholder' => trans('common.select'), 'id' => 'country_id', 'required' => 1]) }}
