        ...
        <div class="row">
            <div class="col-sm-12 col-md-4 my-2 {{ $error_class }}">
                <label class="font-size-15 font-weight-semibold" for="create" style="cursor: pointer;">
                    {{ Form::checkbox('actions[create]', 'yes', false ,['id' => 'create', 'class' => 'form-check-input']) }}
                    @lang('menu.create_action')
                </label>
            ...
            <div class="col-sm-12 col-md-4 my-2 {{ $error_class }}">
                <label class="font-size-15 font-weight-semibold" for="edit" style="cursor: pointer;">
                    {{ Form::checkbox('actions[edit]', 'yes', false ,['id' => 'edit', 'class' => 'form-check-input']) }}
                    @lang('menu.edit_action')
                </label>
                @if ($errors->has('edit'))
                    <p class="text-danger">{{$errors->first('edit')}}</p>
                @endif
            </div>
            <div class="col-sm-12 col-md-4 my-2 {{ $error_class }}">
                <label class="font-size-15 font-weight-semibold" for="view" style="cursor: pointer;">
                    {{ Form::checkbox('actions[view]', 'yes', false ,['id' => 'view', 'class' => 'form-check-input']) }}
                    @lang('menu.view_action')
                </label>
                @if ($errors->has('view'))
                    <p class="text-danger">{{$errors->first('view')}}</p>
                @endif
            </div>
            <div class="col-sm-12 col-md-4 my-2 {{ $error_class }}">
                <label class="font-size-15 font-weight-semibold" for="delete" style="cursor: pointer;">
                    {{ Form::checkbox('actions[delete]', 'yes', false ,['id' => 'delete', 'class' => 'form-check-input']) }}
                    @lang('menu.delete_action')
                </label>
            ...
            <div class="col-sm-12 col-md-4 my-2 {{ $error_class }}">
                <label class="font-size-15 font-weight-semibold" for="print" style="cursor: pointer;">
                    {{ Form::checkbox('actions[print]', 'yes', false ,['id' => 'print', 'class' => 'form-check-input']) }}
                    @lang('menu.print_action')
                </label>
                @if ($errors->has('print'))
                    <p class="text-danger">{{$errors->first('print')}}</p>
                @endif
            </div>
            <div class="col-sm-12 col-md-4 my-2 {{ $error_class }}">
