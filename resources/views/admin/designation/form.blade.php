<div class="row mb-3">
    ...
    <div class="col-sm-12 col-md-4 my-2">
        ...
        <label for="order_by" class="form-label">@lang('designation.order_by')</label>
        <sup class="text-danger">*</sup>
        <div class="form-group">
            {{ Form::text('order_by', null, ['class' => $error_class.'form-control', 'id' => 'order_by', 'required' => false, 'autofocus']) }}
