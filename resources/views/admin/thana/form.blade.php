<div class="row mb-3">
    ...
    <div class="col-md-4 col-sm-4 col-xs-12 my-2">
        ...
        <sup class="text-danger">*</sup>
        <div class="form-group">
            {{ Form::select('district_id', $districts, null, ['class' => $error_class.'form-control select2', 'placeholder' => 'Select One', 'id' => 'district_id', 'onChange'=>'GetFireStations()', 'required' => 1]) }}
