...
<div class="row mb-3">
    ...
    <div class="col-sm-12 col-md-4 my-2">
        ...
        <label for="workshop_id" class="form-label">@lang('employee.workshop')</label>
        <div class="form-group">
...
<div class="row">
    ...
    <div class="col-sm-12 col-md-4 my-2">
        ...
        <img class="img-fluid" style="border: 2px solid #adb5bd;margin: 0 auto; padding: 2px; border-radius: 2%;" id="profile_picture_preview" src="{{asset('assets/common/images/no-image.png')}}" alt="Image Preview">
    </div>
...
<div class="row">
    ...
    <div class="col-sm-12 col-md-4 my-2">
        ...
        <img class="img-fluid" style="border: 2px solid #adb5bd;margin: 0 auto; padding: 2px; border-radius: 2%;" id="signature_preview" src="{{asset('assets/common/images/signature.png')}}" alt="Image Preview">
    </div>
    ...
    <script>
        ...
        $(function () {
            ...
            $('#search_employee').on('click',function () {
                ...
                $.ajax({
                    url: 'https://ehrm.fireservice.gov.bd/api/employees-for-workshop?token=3WarLFaJUF4ECSLicpdjGnjncYCP1auNrcbpt3vQTgJSXoQB6b',
                    type: 'GET',
                    dataType: 'JSON',
                    cache: false,
                    data:{
                    ...
                    success: function (response) {
                        if(response.error === '401'){
                            ...
                            if(response.img_url){
                                ...
                                $.ajax({
                                    url: 'https://ehrm.fireservice.gov.bd/api/employee-image-workshop?token=3WarLFaJUF4ECSLicpdjGnjncYCP1auNrcbpt3vQTgJSXoQB6b',
                                    type: 'GET',
                                    dataType: 'JSON',
                                    cache: false,
                                    data:{
                            ...
                            if(response.signature_url){
                                ...
                                $.ajax({
                                    url: 'https://ehrm.fireservice.gov.bd/api/employee-signature-workshop?token=3WarLFaJUF4ECSLicpdjGnjncYCP1auNrcbpt3vQTgJSXoQB6b',
                                    type: 'GET',
                                    dataType: 'JSON',
                                    cache: false,
                                    data:{
                    ...
                    error: function (xhr) {
                        ...
                        toastr.error( 'এই পিন নম্বর দিয়ে কাউকে খুজে পাওয়া যায়নি! সঠিক পিন নম্বর দিয়ে আবার চেস্টা করুন।',null, {
                            closeButton: true,
                            progressBar: true,
                        });
                    }
