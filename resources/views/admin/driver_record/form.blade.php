<div id="vue" class="row mb-3">
    ...
    <div class="mt-3">
        <hr>
        <h6 class="font-weight-semibold">@lang('driver_record.driver_records')</h6>
        <div v-for="(row,index) in driver_record_inputs">
            <div  class="border border-secondary mb-6 p-3 my-2">
                ...
                <div class="col-sm-12 text-right">
                    <button v-if="index != 0" type="button" class="btn btn-danger btn-sm" @click="removeDriverRecords(index)"><i
                            class="fas fa-times text-warning"></i> </button>
                </div>
                <div class="row" >
                    <div class="col-sm-12 col-md-4 my-2">
                        @php /** @var string $errors */
                            $error_class = $errors->has('driver_employee_id') ? 'parsley-error ' : ''; @endphp
                        <label for="driver_employee_id" class="form-label">@lang('driver_record.driver_employee_id',['model' => trans('driver_record.driver_record')])</label>
                        <div class="form-group">
                            <select v-model="row.driver_employee_id" :name="'driver_record_details['+index+'][driver_employee_id]'" class="{{$error_class}} form-control" required>
                                <option value="">@lang('common.select')</option>
                                <option v-for="(driver,index) in drivers" :value="index" :selected="index == row.driver_employee_id">@{{driver}}</option>
                            </select>
                            @if ($errors->has('driver_records'))
                                <p class="text-danger">{{$errors->first('driver_records')}}</p>
                            @endif
                        </div>
                    </div>
                    ...
                    <div class="col-sm-12 col-md-4 my-2">
                        ...
                        <label for="in_date" class="form-label">@lang('driver_record.in_date',['model' => trans('driver_record.driver_record')])</label>
                        <div class="form-group">
                            <input pattern="/^(0[1-9]|1\d|2\d|3[01])\-(0[1-9]|1[0-2])\-(1|2)\d{3}$/" placeholder="dd-mm-yyyy" v-model="row.in_date" class="{{$error_class}} form-control"
                                   :name="'driver_record_details['+index+'][in_date]'" id="in_date">
                    ...
                    <div class="col-sm-12 col-md-4 my-2">
                        @php /** @var string $errors */
                            $error_class = $errors->has('in_meter_reading') ? 'parsley-error ' : ''; @endphp
                        <label for="in_meter_reading" class="form-label">@lang('driver_record.in_meter_reading',['model' => trans('driver_record.driver_record')])</label>
                        <div class="form-group">
                            <input v-model="row.in_meter_reading" class="{{$error_class}} form-control"
                                   :name="'driver_record_details['+index+'][in_meter_reading]'" id="in_meter_reading">
                            {{--                            {{ Form::text('in_meter_reading', null, ['class' => $error_class.'form-control', 'id' => 'in_meter_reading', 'required' => false]) }}--}}
                            @if ($errors->has('in_meter_reading'))
                                <p class="text-danger">{{$errors->first('in_meter_reading')}}</p>
                            @endif
                        </div>
                    </div>
                    ...
                    <div class="col-sm-12 col-md-4 my-2">
                        ...
                        <label for="out_date" class="form-label">@lang('driver_record.out_date',['model' => trans('driver_record.driver_record')])</label>
                        <div class="form-group">
                            <input pattern="/^(0[1-9]|1\d|2\d|3[01])\-(0[1-9]|1[0-2])\-(1|2)\d{3}$/" placeholder="dd-mm-yyyy" v-model="row.out_date" class="{{$error_class}} form-control"
                                   :name="'driver_record_details['+index+'][out_date]'" id="out_date">
                    ...
                    <div class="col-sm-12 col-md-4 my-2">
                        @php /** @var string $errors */
                            $error_class = $errors->has('out_meter_reading') ? 'parsley-error ' : ''; @endphp
                        <label for="out_meter_reading" class="form-label">@lang('driver_record.out_meter_reading',['model' => trans('driver_record.driver_record')])</label>
                        <div class="form-group">
                            <input v-model="row.out_meter_reading" class="{{$error_class}} form-control"
                                   :name="'driver_record_details['+index+'][out_meter_reading]'" id="out_meter_reading">
                            {{--                            {{ Form::text('out_meter_reading', null, ['class' => $error_class.'form-control', 'id' => 'out_meter_reading', 'required' => false]) }}--}}
                            @if ($errors->has('out_meter_reading'))
                                <p class="text-danger">{{$errors->first('out_meter_reading')}}</p>
                            @endif
                        </div>
                    </div>
                    ...
                    <div class="col-sm-12 col-md-4 my-2">
                        @php /** @var string $errors */
                            $error_class = $errors->has('sso_so_employee_id') ? 'parsley-error ' : ''; @endphp
                        <label for="sso_so_employee_id" class="form-label">@lang('driver_record.sso_so_employee_id',['model' => trans('driver_record.driver_record')])</label>
                        <div class="form-group">
                            <select v-model="row.sso_so_employee_id" :name="'driver_record_details['+index+'][sso_so_employee_id]'" class="{{$error_class}} form-control">
                                <option value="">@lang('common.select')</option>
                                <option v-for="(employee,index) in employees" :value="index" :selected="index == row.sso_so_employee_id">@{{employee}}</option>
                            </select>
        ...
        <div class="col-sm-12 text-right">
            <a href="javascript:" class="btn btn-success"  @click="addMoreDriverRecords">
                <i class="fa fa-plus-circle"></i>
                @lang('driver_record.add_driver_records')
            </a>
        </div>
    </div>
    ...
    <div class="col-sm-12 col-md-4 my-2">
        ...
        <label for="status" class="form-label">@lang('common.status',['model' => trans('driver_record.driver_record')])</label>
        <sup class="text-danger">*</sup>
        <div class="form-group form-group-check pl-4">
            <div class="form-check-custom">
                ...
                <label class="form-check-label" for="active">
                    @lang('common.active',['model' => trans('driver_record.driver_record')])
                </label>
            </div>
            ...
            <div class="form-check-custom">
                ...
                <label class="form-check-label" for="inactive">
                    @lang('common.inactive',['model' => trans('driver_record.driver_record')])
                </label>
            </div>
...
{{--<div class="row">
    <div class="col-sm-12 col-md-4 my-2">
        ...
        <label for="from_employee_signature" class="form-label">@lang('driver_record.from_employee_signature')</label>
        <div class="form-group">
    ...
    <div class="col-sm-12 col-md-4 my-2">
        <label class="col-form-label" for="from_employee_signature">@lang('driver_record.from_employee_signature_preview')</label><br>
    ...
    @if(Request::segment(4) == 'edit')
        <div class="col-sm-12 col-md-4 my-2">
            <label class="col-form-label">
                @lang('driver_record.from_employee_signature_existing')
                {{ Form::checkbox('remove_from_employee_signature', null, null, ['class' => 'form-check-input', 'id' => 'remove_from_employee_signature']) }}
                <label for="remove_from_employee_signature" class="form-label">@lang('driver_record.remove_from_employee_signature')</label>
            </label><br>
            <img class="img-fluid" style="border: 2px solid #adb5bd;margin: 0 auto; padding: 2px; border-radius: 2%;" src="{{asset($driver_record->from_employee_signature->source ?? '')}}" alt="@lang('driver_record.from_employee_signature_existing')">
        </div>
    @endif
</div>
<div class="row">
    <div class="col-sm-12 col-md-4 my-2">
        ...
        <label for="to_employee_signature" class="form-label">@lang('driver_record.to_employee_signature')</label>
        <div class="form-group">
    ...
    <div class="col-sm-12 col-md-4 my-2">
        <label class="col-form-label" for="to_employee_signature">@lang('driver_record.to_employee_signature_preview')</label><br>
    ...
    @if(Request::segment(4) == 'edit')
        <div class="col-sm-12 col-md-4 my-2">
            <label class="col-form-label">
                @lang('driver_record.to_employee_signature_existing')
                {{ Form::checkbox('remove_to_employee_signature', null, null, ['class' => 'form-check-input', 'id' => 'remove_to_employee_signature']) }}
                <label for="remove_to_employee_signature" class="form-label">@lang('driver_record.remove_to_employee_signature')</label>
            </label><br>
            <img class="img-fluid" style="border: 2px solid #adb5bd;margin: 0 auto; padding: 2px; border-radius: 2%;" src="{{asset($driver_record->to_employee_signature->source ?? '')}}" alt="@lang('driver_record.to_employee_signature_existing')">
        </div>
    @endif
</div>--}}
...
<div class="row">
    <div class="col-md-12 text-center">
        <button type="submit" class="btn btn-primary waves-effect waves-light">
            <i class="fa fa-save"></i> @lang('common.submit',['model' => trans('driver_record.driver_record')])
        </button>
    </div>
</div>
...
<script>
    ...
    $(function () {
        let vue = new Vue({
            ...
            methods: {
                addMoreDriverRecords(){
                    this.driver_record_inputs.push({
                        driver_employee_id:'',
                        in_date:'',
                        in_meter_reading:'',
                        out_date:'',
                ...
                removeDriverRecords(index) {
                    this.driver_record_inputs.splice(index, 1);
                },
                load_parameters(){
                    {{--console.log({!! @$driver_record->driverRecordDetails !!})--}}
                    this.driver_record_inputs = {!! @$driver_record->driverRecordDetails ?? '{}' !!}
                },
            },
            created() {
                @if(\Route::currentRouteName() == 'driver_record.edit')
    ...
    $(document).on('submit', '.driver_record_submit', function (event) {
        $('#loader').show();
            ...
            error: function (xhr, status, exception) {
                ...
                if (exception === 'Bad Request'){
                    ...
                    for(const [index, error] of errors.entries()){
                        ...
                        if (error[0].includes('driver_record_details.')){
