<div class="row mb-3">
    <div class="col-sm-4 col-md-6 my-2">
        ...
        <label for="name" class="form-label">@lang('fire_station_type.label_name')</label>
    ...
    <div class="col-sm-4 col-md-6 my-2">
        ...
        <label for="bn_name" class="form-label">@lang('fire_station_type.label_bn_name')</label>
    ...
    <div class="col-sm-4 col-md-6 my-2">
        ...
        <label for="status" class="form-label">@lang('fire_station_type.label_status')</label>
        <sup class="text-danger">*</sup>
        <div class="form-group form-group-check pl-4">
            <div class="form-check-custom">
                ...
                <label class="form-check-label" for="active">
                    @lang('fire_station_type.label_status_active')
                </label>
            </div>
            ...
            <div class="form-check-custom">
                ...
                <label class="form-check-label" for="inactive">
                    @lang('fire_station_type.label_status_inactive')
                </label>
            </div>
...
<div class="row">
    <div class="col-md-12 text-right">
        <button type="submit" class="btn btn-primary waves-effect waves-light">
            <i class="fa fa-save"></i> @lang('fire_station_type.label_submit_button')
        </button>
    </div>
</div>
