                                    ...
                                    <div class="mb-1 mt-1 my-auto">
                                        ...
                                        <div class="mt-1">
                                            ...
                                            <div class="mt-3 text-center">
                                                <p class="mb-1">--}}
{{--@lang('auth.label_no_account') --}}{{--
<a href="{{route('register')}}" class="fw-medium text-primary"> @lang('login.label_create_new_account') </a> </p>
                                                <p class="mb-1">--}}
{{--@lang('auth.label_no_account') --}}{{--
<a href="{{route('login')}}" class="fw-medium text-primary"> @lang('login.label_do_login') </a> </p>
                                            </div>
                                        </div>
                                    </div>
